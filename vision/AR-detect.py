...
aruco_dict = aruco.Dictionary_get(aruco.DICT_5X5_250)  # You can choose another dictionary
parameters = aruco.DetectorParameters_create()

# Start the video capture
cap = cv2.VideoCapture(4) # On my computer USB Camera is on port /dev/video4
